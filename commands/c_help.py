...
async def start(message: Message) -> None:
    ...
    """
    logger.info("Запущена функция c_help.start", username=message.from_user.username, user_id=message.chat.id)
...
Если у Вас есть замечания или пожелания по улучшению работы Бота, Вы можете сообщить о них в поддержку: https://t.me/+NtNLZMJ7x_o4N2U6)
Разработчик - https://t.me/NickitaOrlov
""",
    )
